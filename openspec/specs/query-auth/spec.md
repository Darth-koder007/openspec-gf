...
Simple query-string based authentication mechanism for identifying users during development and testing. This is explicitly a temporary solution and not production-ready security.
